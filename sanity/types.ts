...
// Query: *[_type == "startup" && author._ref == $_id] | order(_createdAt desc) {    _id,    title,    slug,     _createdAt,    author -> {      _id,       name,      image,       bio    },    views,     description,    category,     image  }
...
// Query: *[_type == "author" && id == $id][0] {    _id,    name,    username,    image,    bio,    id  }
...
// Query: *[_type == "author" && _id == $id][0] {    _id,    name,    username,    image,    bio,    id  }
